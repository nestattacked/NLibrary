//from github https://github.com/pod32g/MD5
...
namespace nlib{
	namespace md5{
		...
		void md5(const char *initial_msg, unsigned char *digest) {
		 
			//length of initial_msg
			unsigned int initial_len = strlen(initial_msg);
